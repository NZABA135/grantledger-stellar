...
A donor creates a grant in the smart contract

Funds are transferred to the contract escrow

The project progresses

A verifier authorizes fund release

Funds are distributed to the NGO
